...
export const INITIAL_MARKET_DATA: MarketData[] = [
  { symbol: 'GOLD', name: '금거래', price: 0, change: 0, changePercent: 0, high: 0, low: 0, volume: 0, category: '통화' },
  { symbol: 'GBP', name: '파운드', price: 0, change: 0, changePercent: 0, high: 0, low: 0, volume: 0, category: '통화' },
  { symbol: 'BTC', name: 'BTC', price: 0, change: 0, changePercent: 0, high: 0, low: 0, volume: 0, category: '통화' },
  { symbol: 'SILVER', name: '은거래', price: 0, change: 0, changePercent: 0, high: 0, low: 0, volume: 0, category: '통화' },
];
