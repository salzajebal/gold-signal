...
한국어 이진 옵션 투자 플랫폼. 사용자가 금거래(GOLD), 파운드(GBP/USD), BTC, 은거래(SILVER)의 가격 변동 방향(상승/하락)에 베팅합니다. Yahoo Finance API를 통한 실시간 시장 데이터, lightweight-charts 캔들스틱 차트, 계좌 시스템을 제공합니다.
...
- **Trading Assets**: GOLD (금거래), GBP (파운드/GBP·USD), BTC (비트코인), SILVER (은거래)
- **Trading Durations**: 3분 (180s), 5분 (300s)
- **Min Bet**: 10,000원
